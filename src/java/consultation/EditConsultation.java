...
public class EditConsultation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Consultation consultation = consultationFacade.find(Long.valueOf(request.getParameter("id")));
        ...
        if (ordonnanceNeeded != null) {
            ...
            String[] parameterValues = request.getParameterValues("medicamentAdded");
            if(parameterValues != null ) for (String medicId : parameterValues) {
        ...
        if (investigationNeeded != null) {
            ...
            String[] parameterValues = request.getParameterValues("InvestigationAdded");
            if(parameterValues != null ) for (String investID : parameterValues ) {
