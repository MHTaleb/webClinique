 ...
 */
@WebServlet(
    name        = "MedicamentServlet",
    urlPatterns = "/MedicamentServlet"
)
public class MedicamentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Medicament medicament   = medicamentFacade.find(idMedicament);

        if (todo.equalsIgnoreCase("editMedic")) {
            medicament.setTitre(request.getParameter("titre"));
            medicamentFacade.edit(medicament);
        } else if (todo.equals("delete")) {
            medicamentFacade.remove(medicament);
        }
