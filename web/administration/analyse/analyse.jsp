...
<%
    ...
    List<RDV> allPatients = (List<RDV>) request.getServletContext().getAttribute("allRDV");
    
    List<Consultation> allPatientsValid = (List<Consultation>) request.getServletContext().getAttribute("allConsultation");
    int size = 0;
    if (allPatients != null) {
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class=" w3-margin w3-card-4" >
                ...
                <ul class="w3-ul " id="myUL" style="overflow-y: auto;max-height: 457px;">
                    ...
                    <li class="w3-padding-16">
                        <form action="./Consultation" method="post" id="form<%=i%>">
                            <input type="hidden" name="id" value="<%= allPatients.get(i).getId()%>"/>
                        ...
                        <span class="w3-xlarge"><b><% out.print(allPatients.get(i).getPatient().getInfoPersonnel().getNom() + " " + allPatients.get(i).getPatient().getInfoPersonnel().getPrenom());%> Date : <% out.print(allPatients.get(i).getDateRDV());%> </b></span><br>
                        <span><b>  Date de naissance : </b><% out.print(allPatients.get(i).getPatient().getInfoPersonnel().getDate_naissance()); %></span>
                        <span><b>  T&eacute;l&eacute;phone : </b><%out.print(allPatients.get(i).getPatient().getInfoPersonnel().getTel());%></span>
                        <span><b>  Adresse : </b> <%out.print(allPatients.get(i).getPatient().getInfoPersonnel().getAdresse());%></span>
                    </li>
                    <%}
                    } else {%>
                    <%}%>
            ...
            <div class=" w3-margin w3-card-4" >
                ...
                <Table class="w3-table w3-bordered w3-striped w3-container w3-hoverable" id="myTable" style="overflow-y: auto;max-height: 457px;">
                    ...
                    <%
                        int counter = 0;
                        for (Consultation rdv : allPatientsValid) {
                    %>
                    <tr <%
                          counter++;
                        ...
                        <td ><% out.print(rdv.getMedecin().getInfoPersonnel().getNom()+" "+rdv.getMedecin().getInfoPersonnel().getNom()); %></td>
                    </tr>
                    <%
                        }
                    %>
