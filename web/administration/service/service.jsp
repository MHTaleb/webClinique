    ...
    <body class="w3-light-grey">
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <a href="./Board" class="w3-bar-item w3-button w3-margin "><i class="fa fa-home fa-fw"></i>  Prinipal</a>
                <a href="./ShowAllClient" class="w3-bar-item w3-button w3-margin "><i class="fa fa-users fa-fw"></i>  Liste des clients</a>
                <a href="./AllRDV" class="w3-bar-item w3-button w3-margin"><i class="fa fa-calendar fa-fw"></i>  Rendez-Vous</a>
                <a href="./Consultation" class="w3-bar-item w3-button w3-margin"><i class="fa fa-stethoscope fa-fw"></i>  Consultation</a>
                <a href="./Medicaments" class="w3-bar-item w3-button w3-margin"><i class="fa fa-medkit fa-fw"></i>  Medicaments et Investigation</a>
                <a href="./Personnel" class="w3-bar-item w3-button w3-margin"><i class="fa fa-user-md fa-fw"></i>  Personnel </a>
                <a href="./ServiceRedirect" class="w3-bar-item w3-button w3-margin w3-blue"><i class="fa fa-bank fa-fw"></i>  Service</a>
                <a href="#" class="w3-bar-item w3-button w3-margin"><i class="fa fa-history fa-fw"></i>  History</a>
                <a href="#" class="w3-bar-item w3-button w3-margin"><i class="fa fa-cog fa-fw"></i>  Settings</a><br><br>
            </div>            
        </nav>
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class=" w3-margin w3-card-4" >
                ...
                <input style="width: 100%" class="w3-input  w3-margin" type="text" placeholder="Recherche" id="myInputsearch" onkeyup="myFunctionSearch()">
                <ul class="w3-ul w3-blue-grey" id="myULSearch" style="overflow-y: auto;max-height: 457px;">
                    <%
                        if (size > 0) {
                    ...
                    <li class="w3-padding-16">
                        <form action="./RemoveService" method="post" id="form<%=i%>">
                            <input type="hidden" name="id" value="<%= allServices.get(i).getId()%>"/>
                        ...
                        <img src="../images/service.png" class="w3-left w3-circle w3-margin-right" style="width:50px">
                        <span class="w3-xlarge"><b><% out.print(allServices.get(i).getTitre());%></b></span><br>
                        <span><b>  Chef Service : </b><% out.print(allServices.get(i).getChef_service().getInfoPersonnel().getNom() + " " + allServices.get(i).getChef_service().getInfoPersonnel().getPrenom()); %></span>
            ...
            <div class="w3-card-4 w3-white   w3-margin">
                ...
                <form action="./AddService" method="post" class="w3-container w3-row-padding w3-margin">

                    <input class="w3-input w3-large  w3-border-bottom w3-hover-text-blue w3-hover-border-blue " style="max-width: 100%" required="" name="titre" type="text" placeholder="Titre du Service " />
                    <br>
                    <br>
                    <select class="w3-select w3-large" autocomplete="" name ="chefID">
                        <option value=" " disabled="" selected="">
                            Choisir le Chef de Service
                        </option>

                        <%
                            for (int i = 0; i < allMedecins.size(); i++) {
                        %>
                        <option value="<%out.print(allMedecins.get(i).getId());%>"> <%out.print(allMedecins.get(i).getInfoPersonnel().getNom() + " " + allMedecins.get(i).getInfoPersonnel().getPrenom());%> </option>
                        <%}%>
                    </select>
                    <br>
                    <br>
...
function myFunction() {
    var input, filter, ul, li, a, i;
    input = document.getElementById("myInputMedecin");
    filter = input.value.toUpperCase();
    ul = document.getElementById("myMedecins");
    li = ul.getElementsByTagName("li");
    for (i = 0; i < li.length; i++) {
        if (li[i].innerHTML.toUpperCase().indexOf(filter) > -1) {
            li[i].style.display = "";
            ...
            li[i].style.display = "none";
                    ...
                    <div class="w3-border">
                    <input class="w3-input w3-large w3-border-bottom " type="text" placeholder="Search for names.." id="myInputMedecin" onkeyup="myFunction()">
                    <ul class="w3-ul  w3-margin-top" id="myMedecins">

                        <%
                            for (int i = 0; i < allMedecins.size(); i++) {
                        %>
                        <li class="w3-li w3-hover-green" > 
                            <span class="w3-large "><%out.print(allMedecins.get(i).getInfoPersonnel().getNom() + " " + allMedecins.get(i).getInfoPersonnel().getPrenom());%> 
                            <input type="checkbox" class="w3-check w3-right " name="listMedecins" value="<%out.print(allMedecins.get(i).getId());%>">
                            </span> 
                        </li>
