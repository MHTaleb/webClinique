            ...
            <div class=" w3-margin w3-card-4 w3-white" >
                ...
                <form action="./AddMedecin" method="post" class="w3-container w3-row-padding w3-margin">
                    ...
                    <div class="w3-row">
                        ...
                        <input class="w3-input w3-large w3-col s2 w3-border-bottom w3-hover-text-blue w3-hover-border-blue "  required="" name="glecemie" type="text" placeholder="Glécemie " />
                    </div>
