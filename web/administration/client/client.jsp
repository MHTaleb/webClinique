...
<%
    ...
    List<Patient> patients = (List<Patient>) request.getServletContext().getAttribute("allClient");
    String clientCount = "" + patients.size();
    int size = 0;
    if (patients != null) {
        size = patients.size();
    }
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class=" w3-margin w3-card-4" >
                <div class="w3-container w3-purple">
                    <h2> Liste des clients de la Clinique</h2>
                </div>
                ...
                <ul class="w3-ul " id="myUL" style="overflow-y: auto;max-height: 457px;">
                    ...
                    <li class="w3-padding-16">
                        <form action="./RemoveClient" method="post" id="form<%=i%>">
                            <input type="hidden" name="id" value="<%= patients.get(i).getId()%>"/>
                        ...
                        <%
                            if(patients.get(i).getInfoPersonnel().isSexe()){
                        %>
                        <img src="../images/boss.png" class="w3-left w3-circle w3-margin-right" style="width:50px">
                        <%}else{%>
                        <img src="../images/stewardess.png" class="w3-left w3-circle w3-margin-right" style="width:50px">
                        <%}%>
                        <span class="w3-xlarge"><b><% out.print(patients.get(i).getInfoPersonnel().getNom() + " " + patients.get(i).getInfoPersonnel().getPrenom());%></b></span><br>
                        <span><b>  Date de naissance : </b><% out.print(patients.get(i).getInfoPersonnel().getDate_naissance()); %></span>
                        <span><b>  T&eacute;l&eacute;phone : </b><%out.print(patients.get(i).getInfoPersonnel().getTel());%></span>
                        <span><b>  Adresse : </b> <%out.print(patients.get(i).getInfoPersonnel().getAdresse());%></span>
                    </li>
                    <%}
                    } else {%>
                    <%}%>
            ...
            <div class="w3-card-4 w3-white   w3-margin">
                ...
                <form action="./AddClient" method="post" class="w3-container w3-row-padding w3-margin">
